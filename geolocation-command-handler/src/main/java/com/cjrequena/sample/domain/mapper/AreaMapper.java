...
/**
 * Pure MapStruct interface for bidirectional conversion between the
 * {@link Area} domain aggregate and the {@link AreaEntity} JPA entity.
 *
 * <h3>Conversion summary</h3>
 * <table>
 *   <tr><th>Domain</th><th>Entity</th><th>Strategy</th></tr>
 *   <tr><td>id, name, postalCode, active</td><td>same</td><td>direct {@code @Mapping}</td></tr>
 *   <tr><td>cityId (UUID)</td><td>city (CityEntity)</td>
 *       <td>shell entity — {@code @AfterMapping}</td></tr>
 *   <tr><td>geoShapeId (UUID)</td><td>geoShape (GeoShapeEntity)</td>
 *       <td>shell entity — {@code @AfterMapping}</td></tr>
 *   <tr><td>type (AreaType)</td><td>areaType (String)</td>
 *       <td>enum getValue/fromValue — {@code @AfterMapping}</td></tr>
 *   <tr><td>population (PopulationVO)</td><td>population (Long)</td>
 *       <td>VO flatten — {@code @AfterMapping}</td></tr>
 *   <tr><td>auditInfo (AuditInfoVO)</td><td>createdAt / updatedAt</td>
 *       <td>VO flatten — {@code @AfterMapping}</td></tr>
 * </table>
 */
