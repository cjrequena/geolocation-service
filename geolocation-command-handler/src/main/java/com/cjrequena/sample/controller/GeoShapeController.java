...
@Log4j2
@RestController
@RequestMapping(value = GeoShapeController.ENDPOINT, headers = {GeoShapeController.ACCEPT_VERSION})
...
public class GeoShapeController {
  ...
  @PostMapping
  @Operation(
    summary = "Create a new geographic shape",
  ...
  @ApiResponses(value = {
    @ApiResponse(
      ...
      content = @Content(
        schema = @Schema(implementation = GeoShapeResponseDTO.class)
      )
    ),
  ...
  public ResponseEntity<GeoShapeResponseDTO> createGeoShape(@Valid @RequestBody GeoShapeRequestDTO requestDTO) {
    ...
    GeoShape geoShape = this.geoShapeMapper.requestDTOtoDomain(requestDTO);

    // Create via service
    GeoShape created = geoShapeService.create(geoShape);

    // Convert to response DTO
    GeoShapeResponseDTO responseDTO = geoShapeMapper.domainToResponseDTO(created);
  ...
  @Operation(
    ...
    description = "Retrieves a geographic shape by its unique identifier"
  )
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200", description = "Shape found",
  ...
  public ResponseEntity<GeoShapeResponseDTO> updateGeoShape(
    ...
    // Convert to response DTO
    GeoShapeResponseDTO responseDTO = geoShapeMapper.domainToResponseDTO(updated);
