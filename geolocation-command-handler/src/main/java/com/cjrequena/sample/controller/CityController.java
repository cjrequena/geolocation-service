...
//      UUID.randomUUID(),
//      UUID.fromString(requestDTO.getRegionId()),
//      requestDTO.getName(),
...
//      requestDTO.getCapital() != null ? requestDTO.getCapital() : Boolean.FALSE,
...
//    CityResponseDTO responseDTO = cityMapper.toResponseDTO(created);
//
...
//
//    // Convert to response DTO
//    CityResponseDTO responseDTO = cityMapper.toResponseDTO(updated);
//
