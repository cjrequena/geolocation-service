...
//      requestDTO.getName(),
//      requestDTO.getCode(),
//      RegionType.valueOf(requestDTO.getRegionType()),
...
//    RegionResponseDTO responseDTO = regionMapper.toResponseDTO(created);
//
...
//   */
//  @GetMapping
//  @Operation(summary = "Get all regions", description = "Retrieves all regions")
//  @ApiResponses(value = {
...
//    @Parameter(description = "Region ID", required = true)
//    @PathVariable UUID id,
//    @Valid @RequestBody UpdateRegionRequestDTO requestDTO) {
//
...
//
//    // Convert to response DTO
//    RegionResponseDTO responseDTO = regionMapper.toResponseDTO(updated);
//
...
//
//  /**
//   * Get regions by timezone.
//   *
//   * @param timezone the timezone identifier
//   * @return list of regions in the timezone
//   */
//  @GetMapping("/timezone/{timezone}")
//  @Operation(summary = "Get regions by timezone", description = "Retrieves all regions in a specific timezone")
//  @ApiResponses(value = {
//    @ApiResponse(responseCode = "200", description = "Regions retrieved successfully")
//  })
//  public ResponseEntity<List<RegionResponseDTO>> getRegionsByTimezone(
//    @Parameter(description = "IANA timezone identifier (e.g., America/Los_Angeles)", required = true)
//    @PathVariable String timezone) {
//
//    log.debug("Getting regions by timezone: {}", timezone);
//
//    List<RegionResponseDTO> regions = regionService.findByTimezone(timezone).stream()
//      .map(regionMapper::toResponseDTO)
//      .collect(Collectors.toList());
//
//    return ResponseEntity.ok(regions);
...
//  @Operation(summary = "Check if region exists", description = "Checks if a region exists by ID")
//  @ApiResponses(value = {
