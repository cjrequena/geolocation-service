...
public class ZoneController {
  ...
  /**
   * Get all zones with optional filtering, sorting, and pagination.
   *
  ...
  @GetMapping
  @Operation(
    summary = "Get all zones with filtering, sorting, and pagination",
    description = "Retrieves zones with optional RSQL filters, sorting, and pagination support"
  )
  @ApiResponses(value = {
  ...
  public ResponseEntity<List<ZoneResponseDTO>> retrieve(
    ...
    log.debug("Getting zones with filters: {}, offset: {}, limit: {}, sort: {}",
